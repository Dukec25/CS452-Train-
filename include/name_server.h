...
typedef enum Server_err {
	...
	SERVER_ERR_FAILURE					= 0x1,
	SERVER_ERR_INVALID_NAME 			= 0x10,
	SERVER_ERR_INVALD_TASK				= 0x11,
	SERVER_ERR_INVALD_SERVER			= 0x12,
	SERVER_ERR_ALREADY_REGISTERED		= 0x13,
	SERVER_ERR_NOT_REGISTERED			= 0x14,
	SERVER_ERR_MAX_NUM_NAMES_REACHED	= 0x15
} Server_err;
